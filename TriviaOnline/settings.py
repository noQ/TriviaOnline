# Django settings for TriviaOnline project.
import mongoengine
...
_MONGODB_HOST = '10.100.63.65'
_MONGODB_NAME = 'trivia'

mongoengine.connect(_MONGODB_NAME, host=_MONGODB_HOST)

''' define game server address and port '''
GAME_SERVER_ADDRES = "10.100.63.65"
GAME_SERVER_PORT   = 11000
...
SECRET_KEY = '=f_kak2m9mt05om%t9tcv!u%_lj*0brj=$l=w4c^zti1%j^=+o'
...
MIDDLEWARE_CLASSES = (
    ...
    'engine.middleware.TokenMiddleware',
...
ROOT_URLCONF = 'TriviaOnline.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'TriviaOnline.wsgi.application'
